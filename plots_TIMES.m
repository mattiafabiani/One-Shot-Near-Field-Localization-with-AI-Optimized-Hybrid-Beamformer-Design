...
save_path = './imgs/TIMES/';
fontsize = 2;
SNR_dB = 0:5:20;

%% Load Variables
csv_filename = 'test_rmse.csv';
model_path = 'saved_models/single_user_TIMES/hyb_configs/';
DNN_hyb_fully_RF16 = readtable(strcat(model_path,'fully-connected_epochs80_batch256_lr0.001_16RF_256N_dnn/',csv_filename));
CNN_hyb_fully_RF16 = readtable(strcat(model_path,'fully-connected_epochs80_batch256_lr0.001_16RF_256N_/',csv_filename));
CNN_hyb_inter_RF16 = readtable(strcat(model_path,'inter-connected_epochs80_batch256_lr0.001_16RF_256N_/',csv_filename));
CNN_hyb_sub_RF16 = readtable(strcat(model_path,'sub-connected_epochs80_batch256_lr0.001_16RF_256N_/',csv_filename));

% varying the number of RF CHAINS N_RF
csv_filename = 'test_rmse.csv';
model_path = 'saved_models/single_user_TIMES/N_RF/';
CNN_hyb_sub_RF8_polar_uniform = readtable(strcat(model_path,'sub-connected_epochs80_batch256_lr0.001_8RF_256N_/',csv_filename));
CNN_hyb_sub_RF16_polar_uniform = readtable(strcat(model_path,'sub-connected_epochs80_batch256_lr0.001_16RF_256N_/',csv_filename));
CNN_hyb_sub_RF32_polar_uniform = readtable(strcat(model_path,'sub-connected_epochs80_batch256_lr0.001_32RF_256N_/',csv_filename));
CNN_hyb_sub_RF64_polar_uniform = readtable(strcat(model_path,'sub-connected_epochs80_batch256_lr0.001_64RF_256N_/',csv_filename));
% CNN_hyb_sub_RF128_polar_uniform = readtable(strcat(model_path,'sub-connected_epochs50_batch256_lr0.001_128RF_128N_/',csv_filename));

% Multipath
csv_filename = 'test_rmse85.csv';
model_path = 'saved_models/single_user_TIMES/multipath/';
% multipath_CNN_sub_N128_RF8 = readtable(strcat(model_path,'sub-connected_epochs50_batch256_lr0.001_8RF_128N__uniform/',csv_filename));
% multipath_CNN_sub_N128_RF16 = readtable(strcat(model_path,'sub-connected_epochs50_batch256_lr0.001_16RF_128N__uniform/',csv_filename));
...
multipath_CNN_sub_N128_RF16 = readtable(strcat(model_path,'sub-connected_epochs80_batch256_lr0.001_16RF_256N_/',csv_filename));
multipath_CNN_sub_N128_RF32 = readtable(strcat(model_path,'sub-connected_epochs80_batch256_lr0.001_32RF_256N_/',csv_filename));
...
% N = 128 antennas
% maximum_likelihood_N128_rmse_r = readNPY(strcat(model_path,'300GHz_128N_10trails/results.csv'));
% maximum_likelihood_N128_rmse_theta_deg = readNPY(strcat(model_path,'rmse_theta_deg_N256_128_10.npy'));
% maximum_likelihood_N128_rmse_theta_rad = readNPY(strcat(model_path,'rmse_theta_rad_N256_128_10.npy'));
% maximum_likelihood_N128_rmse_pos = readNPY(strcat(model_path,'rmse_pos_N256_128_10.npy'));
...
rmse_r = [.4, .32, .25, .23, .21] + .01.*ones(1,5);
rmse_pos = [.4, .31, .25, .23, .209];
%% Plotting
...
plot(SNR_dB, rmse_r, '-sk', 'DisplayName', 'fully-digital', 'LineWidth', 1.5); hold off;
...
plot(SNR_dB, rmse_pos, '-sk', 'DisplayName', 'fully-digital', 'LineWidth', 1.5); hold off;

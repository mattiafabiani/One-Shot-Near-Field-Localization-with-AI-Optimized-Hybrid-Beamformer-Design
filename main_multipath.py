...
To train the model type this:                         python main_multipath.py --logdir saved_models/multipath/ --epochs 50 --N_RF 16 --train 1 --dataset_name dataset_scat --type inter-connected --model 1
'''

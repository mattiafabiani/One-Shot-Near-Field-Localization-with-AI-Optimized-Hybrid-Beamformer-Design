...
% DNN_hyb_fully_RF16 = readtable(strcat(model_path,'fully-connected_epochs80_batch256_lr0.001_16RF_128N_dnn_eq/',csv_filename));
% CNN_hyb_fully_RF16 = readtable(strcat(model_path,'fully-connected_epochs100_batch256_lr0.001_16RF_128N_conv2/',csv_filename));
